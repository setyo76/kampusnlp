        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 flex flex-col items-center">
            ...
            */}
            <motion.div 
              ...
              className="relative z-10 rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-[14px] border-gray-50 bg-gray-50 cursor-pointer"
            >
              <Image 
            ...
            >
              <p className="text-[#0F0D2E] text-2xl md:text-3xl font-black tracking-tight">
                Trusted by <span className="text-[#E72F31]">12,340+</span> Alumni
              </p>
              <p className="text-[#A39674] text-lg md:text-xl font-bold uppercase tracking-[0.15em]">
                124 Business Companies
              </p>
              <div className="h-1.5 w-20 bg-[#E72F31]/20 mx-auto mt-4 rounded-full" />
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-[#E72F31] font-bold uppercase tracking-[0.2em] text-xs mb-4">
                Tentang Kami
              </p>
              <h2 className="font-display text-4xl md:text-5xl font-extrabold text-[#0F0D2E] mb-8 leading-[1.15]">
                Membangun Performa Puncak Lewat <span className="text-[#E72F31]">Neuro-Linguistic Programming</span>
              </h2>
              ...
              <div className="space-y-6 text-gray-600 font-sans text-lg leading-relaxed">
                ...
                <p>
                  Dipandu langsung oleh <span className="text-[#0F0D2E] font-bold underline decoration-[#E72F31] decoration-4 underline-offset-4">Coach Frans</span>, kami telah membimbing ribuan profesional untuk mentransformasi hambatan mental menjadi batu loncatan kesuksesan yang nyata.
                </p>
              </div>

              {/* Action & Signature */}
              <div className="mt-14 flex flex-col sm:flex-row items-center gap-10">
                <Button className="w-full sm:w-auto bg-[#0F0D2E] text-white px-10 py-5 rounded-2xl hover:bg-[#E72F31] transition-all duration-300 shadow-xl hover:-translate-y-1">
                  Kenali Kami Lebih Dekat
                </Button>
                
                <div className="flex flex-col border-l-4 pl-8 border-[#A39674]/20">
                  <span className="font-display font-black text-[#0F0D2E] text-3xl italic tracking-tighter leading-none">
                    Coach Frans
                  </span>
